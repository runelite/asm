...
sed -e '/TOBEREPLACED/r tutorial-asmdex-body.html' -e '/TOBEREPLACED/d' -e '/!DOCTYPE/d' tutorial-asmdex-holder.html > tutorial-asmdex.html
sed -e '/TOBEREPLACED/r tutorial-asmdex-body.html' -e '/TOBEREPLACED/d' -e '/!DOCTYPE/d' tutorial-asmdex-holder_print.html > tutorial-asmdex_print.html
